...
<img src="https://static.saraba1st.com/image/smiley/face2017/047.png" referrerpolicy="no-referrer">已预购，准备试毒
...
哪里RPG了，这完完全全就是文字ADV啊。目前进度是打完了必定BE的一周目之后又打了两个月。战斗约等于不需要操作，重点是养成部分，系统有趣很值得研究。剧情方面毕竟没玩多少还不好说，觉得有点意思但算不上好。我文字类游戏玩的少，正在说话的人和画面上的立绘不一致是常见的吗？人设不好看是影响我玩下去的最大障碍，只有金发妹子合我胃口，但作为奶来说不如另一个奶T好用，大部分时间都在蹲板凳。虽说周回开始之后就能避开BE了，实际上还是需要先把所有人的BE先打出来吧，估计是这样设置的，每次都要全清空再从头开始打想想就很累不想玩了…先放一阵子等等攻略吧。
...
####  五城桜  
##### 72#       发表于 2023-9-15 21:30

终于打完了。总之不建议浪费时间玩这个。
推荐给喜欢养成类，能从培养角色中获得乐趣的人。
玩法嘛之前说了，更像文字游戏。养成部分就差不多心跳回忆那样，嗯差的有点大。一种手段就是打怪升级，涨数值而且技能槽要升级开，打最终boss之前怕玩家打不过，还专门多了一项练级入口，虽然这里要用信赖度来换。另一种就是上课，主要培养方式，说实话我也没玩太明白，总之强度拉满，体力不够了就给学生ke药，前期针对性拿技能后期缺啥补啥。还有周末外出以及用道具加能力，作用不大。越到后期培养越轻松。
战斗这个不好评价，反正我觉得做得不好，打起来又拖时间又让人血压上升。就是四个选项可以选，后期order配合着用。因为我是二周目直接通关，boss能打但都多少有些费力，过程就极为折磨。技能简单就分为攻击类和辅助类吧。辅助就是装上就能自动或被动触发，比如加能力值啊自动回血啊之类的。攻击技能就是战斗中出现在选项里的，这玩意很气人，这帮烂学生就是不给你跳出来想用的技能。两种技能槽一样多，但实际上辅助的不够用，要针对性的装，攻击技能装太多了选不到，就要针对性的装几个，所以空很多。我就懒了，后面除了比较奇葩的boss我都不会去动装好的技能，总是换来换去多烦啊。order是战斗中比较有用的，不过很多要到后期了。顺便说说角色培养，按最初每个学生的定位来就行，我是走反击流，头一次可以换专攻了，就给大家都学上反击，攻击上不去就增加攻击次数，不过有的boss也会反击并且攻击力特高，经常在互殴过程中把学生打死。需要注意的是上城和凉平两人分别有单独战斗，期间不能用order和道具，所以记得学点回血技能，在开第四个专攻时学就差不多了。朝日因为专用order能算是最强坦克，我专门当T培养的，实际上把回复也多练练比较好。上城作为T只能说有用但作用不大。凉平在对付弱破的怪会派上去，平时板凳。篠森是常用破识主力，培养上看自己想走什么打法。永宫因为成绩好前期就能学全体技能，清小怪好用，但后期大家都行了她就不行了，攻击差扔板凳。浪崎虚识主力，攻击力强，还是在我本来把他当奶培养的情况下，更何况他的专用order是打boss必备，要重点培养。音羽纯奶，板凳队员，及时换上来给大家回血。
剧情…给点面子，就算无聊吧。打到结局本来就烦躁看到那个巨丑的CG我就眼睛一闭一路按下去。我觉得BE反而好些，无论是剧情还是CG。说来也奇怪，这游戏人物画的特别差，绝对不是AI画的因为AI画不了这么差，但怪物就很不错，画的好也有设计感，作为敌方的学生和立绘上的学生简直就不是一个人。流程是从4月到第二年1月，9个月的时间还好，不过我是不想每打出一个BE就再从头打一遍了，累死，直接二周目通关，再从存档回收BE。除了一周目必败的BE之外还有3个BE，前两个还好，最后一个打完没什么剧情，直接送回4月了，就像没做完一样，不如说整个游戏就像半成品，后面强行写的一个大团圆结局。
优点我想想，配音还可以，敌方boss画的不错，搭配技能有点意识，然后没了，缺点说不完，可以当成其他全是缺点。是我没耐心看剧情漏掉了还是什么，标题シカトリス到底是什么意思游戏里有解释吗？


*****

####  唐二想吃火锅  
##### 73#       发表于 2023-9-16 00:29

我非常关心这个游戏什么时候能有中文，好想玩<img src="https://static.saraba1st.com/image/smiley/face2017/138.png" referrerpolicy="no-referrer">
